...
export function Card({
  ...
  return (
    <div className={`dt-surface rounded-2xl border border-slate-200 p-5 shadow-sm ${className}`}>
      {children}
    </div>
  );
}
...
export function Modal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      <div className="absolute inset-0 bg-slate-900/40 backdrop-blur-sm" onClick={onClose} />
      <div className={`animate-fade-up relative flex max-h-[90vh] w-full ${width} flex-col rounded-2xl bg-white shadow-2xl`}>
